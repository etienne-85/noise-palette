...
class ParameterInput {
  ...
  create_context_menu(event, preset_list) {
    ...
    menu.style.top =
      Math.min(event.clientY, window.innerHeight - bounds.height) + "px";
  }
}
...
class RangeInput extends ParameterInput {
  ...
  read() {
    let base = Utils.is_integer(this.step)
      ? parseInt(this.input_number.value)
      : parseFloat(this.input_number.value);
...
export { ParameterInput, SeedInput, RangeInput, SelectInput };
